...
const CreatePost = ()=>{
  ...
  const HandlePost = (event) => {
    ...
    addPost(userId,postTitle,postReact,postBody,Tags);
  }
    ...
    return(
        ...
        <div className="mb-3 ">
          ...
          <input type="text" ref={useridElement} className="form-control" id="userid" aria-describedby="emailHelp" placeholder="your id"/>
        </div>
        ...
        <div className="mb-3 ">
          ...
          <input type="text" ref={postreactElement} className="form-control" id="userid" aria-describedby="emailHelp" placeholder="how many people reacted on this post"/>
        </div>
